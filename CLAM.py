...
from models import CLAMMInterface
...
def main(config):
    ...
    model = CLAMMInterface(**vars(config))
...
if __name__ == "__main__":
    with open("config/clam.yaml", encoding="utf-8") as f:
        file = f.read()
    ...
    excel_file = config.osave_dir+f"/clam_results_{timestamp}.xlsx"
